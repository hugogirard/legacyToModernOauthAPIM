...
public class IdentityProviderService : IIdentityProviderService
{
    ...
    public IdentityProviderService(IConfiguration config, ILoggerFactory loggerFactory)
    {        
        _scopes = new string[] { config["AzureAD:Scopes"] };

        app = PublicClientApplicationBuilder.Create(config["AzureAD:ClientId"])                                            
                                            .WithAuthority(config["AzureAD:Authority"])                                               
                                            .Build();

        _logger = loggerFactory.CreateLogger<IdentityProviderService>();
    }
